...
#define OODLEAPI __stdcall
	...
	SINTa OODLEAPI OodleLZ_Decompress(const char* src, SINTa src_size, char* dst, SINTa dst_size, OodleLZ_FuzzSafe fuzz, OodleLZ_CheckCRC crc, OodleLZ_Verbosity verbosity, char* context, U64 e, void* callback, void* callback_ctx, void* scratch, SINTa scratch_size, OodleLZ_Decode_ThreadPhase thread_phase);
